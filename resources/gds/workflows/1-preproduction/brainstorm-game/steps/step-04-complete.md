...
# Handoff References
gameBriefWorkflow: '{plugin-root}/resources/gds/workflows/1-preproduction/game-brief/workflow.yaml'
gddWorkflow: '{plugin-root}/resources/gds/workflows/2-design/gdd/workflow.yaml'
---
