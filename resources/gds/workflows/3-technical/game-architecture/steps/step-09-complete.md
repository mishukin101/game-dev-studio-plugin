...
# Path Definitions
workflow_path: '{plugin-root}/resources/gds/workflows/3-technical/game-architecture'
...
# Handoff References
epicWorkflow: '{plugin-root}/resources/gds/workflows/4-production/epic-workflow/workflow.yaml'
projectContextWorkflow: '{plugin-root}/resources/gds/workflows/3-technical/generate-project-context/workflow.md'
---
