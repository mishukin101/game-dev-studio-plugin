...
- When 'A' selected: Execute {plugin-root}/resources/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Execute {plugin-root}/resources/core/workflows/party-mode
