...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="ER or fuzzy match on epic-retrospective" data="{plugin-root}/resources/_config/agent-manifest.csv">[ER] Facilitate team retrospective after a game development epic is completed</item>
