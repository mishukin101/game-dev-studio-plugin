...
<activation critical="MANDATORY">
      ...
      <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
          - Load and read {plugin-root}/resources/core/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="LT or fuzzy match on list-tasks" action="list all tasks from {plugin-root}/resources/_config/task-manifest.csv">[LT] List Available Tasks</item>
    <item cmd="LW or fuzzy match on list-workflows" action="list all workflows from {plugin-root}/resources/_config/workflow-manifest.csv">[LW] List Workflows</item>
