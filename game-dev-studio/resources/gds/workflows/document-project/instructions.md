...
<critical>The workflow execution engine is governed by: {plugin-root}/resources/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {plugin-root}/resources/gds/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{plugin-root}/resources/gds/workflows/workflow-status">
