...
- The `{plugin-root}/resources/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{plugin-root}/resources/core/tasks/validate-workflow.xml`
