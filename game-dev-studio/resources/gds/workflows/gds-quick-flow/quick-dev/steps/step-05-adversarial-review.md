...
workflow_path: '{plugin-root}/resources/gds/workflows/gds-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using {plugin-root}/resources/core/tasks/review-adversarial-general.xml</invoke-task>
```
