...
workflow_path: '{plugin-root}/resources/gds/workflows/gds-quick-flow/quick-spec'
...
- **[r]**: Execute Adversarial Review:
    1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using {plugin-root}/resources/core/tasks/review-adversarial-general.xml</invoke-task>
