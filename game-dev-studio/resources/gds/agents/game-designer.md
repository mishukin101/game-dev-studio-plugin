...
<activation critical="MANDATORY">
      ...
      <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
          - Load and read {plugin-root}/resources/gds/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="BG or fuzzy match on brainstorm-game" exec="{plugin-root}/resources/gds/workflows/1-preproduction/brainstorm-game/workflow.md">[BG] Brainstorm Game ideas and concepts</item>
    <item cmd="GB or fuzzy match on game-brief" exec="{plugin-root}/resources/gds/workflows/1-preproduction/game-brief/workflow.md">[GB] Create a Game Brief document</item>
    <item cmd="GDD or fuzzy match on create-gdd" exec="{plugin-root}/resources/gds/workflows/2-design/gdd/workflow.md">[GDD] Create a Game Design Document</item>
    <item cmd="ND or fuzzy match on narrative-design" exec="{plugin-root}/resources/gds/workflows/2-design/narrative/workflow.md">[ND] Design narrative elements and story</item>
    <item cmd="QP or fuzzy match on quick-prototype">[QP] Rapid game prototyping - test mechanics and ideas quickly</item>
    <item cmd="PM or fuzzy match on party-mode" exec="{plugin-root}/resources/core/workflows/bmad-party-mode/workflow.md">[PM] Start Party Mode</item>
