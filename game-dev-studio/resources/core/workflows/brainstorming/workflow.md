...
Load config from `{plugin-root}/resources/core/config.yaml` and resolve:
...
- `installed_path` = `{plugin-root}/resources/core/workflows/brainstorming`
...
- `advancedElicitationTask` = `{plugin-root}/resources/core/workflows/advanced-elicitation/workflow.md`
