...
- Agent manifest CSV is available at `{plugin-root}/resources/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{plugin-root}/resources/_config/agent-manifest.csv`
